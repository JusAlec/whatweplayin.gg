...
| `WWP_WEIGHT_THUMBS`            | number | `"0.5"`  | `readNumber` | recommender weight on the thumbs axis                                                                                           | (n/a)                                                             | Weights need not sum to 1.0 but should for sanity                                |
| `WWP_WEIGHT_OWNERSHIP`         | number | `"0.3"`  | `readNumber` | recommender weight on the ownership-prevalence axis                                                                             | (n/a)                                                             |                                                                                  |
